...
import com.vluver.cbj.colegio.Adaptador.MultiAddImages;
import com.vluver.cbj.colegio.model.AddMoreImages;
import com.vluver.cbj.colegio.servicebackground.UploadImagesPost;
...
public class PostActivity extends AppCompatActivity {
    ...
    ImageView regresar,enviar;
    LinearLayout seleccionar_imagen;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        seleccionar_imagen = (LinearLayout) findViewById(R.id.new_post_submit);
            ...
            public void onClick(View view) {
                if (imageIsSet){
                    ...
                    if (descripcion_post.getText().toString().isEmpty()){
                        descripcion_post.setError("Agrega algo a tu publicacion...");
                    }else{
    ...
    private void insertPostToVluver(String creator, String codeuniqueimages, String description){
        String url = "http://mrsearch.000webhostapp.com/apirestAndroid/insert/setPost.php";
    ...
    protected void onStart() {
        ...
        imm.showSoftInput(descripcion_post, 0);
        super.onStart();
