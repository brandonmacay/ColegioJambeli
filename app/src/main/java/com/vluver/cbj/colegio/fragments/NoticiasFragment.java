...
import com.vluver.cbj.colegio.Adaptador.PostUserAdapter;
import com.vluver.cbj.colegio.Adaptador.SliderAdapterExample;
import com.vluver.cbj.colegio.MainActivity;
import com.vluver.cbj.colegio.PostActivity;
import com.vluver.cbj.colegio.R;
import com.vluver.cbj.colegio.VolleySingleton;
import com.vluver.cbj.colegio.model.Posts;
import com.vluver.cbj.colegio.utilidades.OnLoadMoreListener;
...
public class NoticiasFragment extends Fragment implements SwipeRefreshLayout.OnRefreshListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        FloatingActionButton fab = (FloatingActionButton) view.findViewById(R.id.fab_post);
        ...
        mAdapter.setOnLoadMoreListener(new OnLoadMoreListener() {
            ...
            public void onLoadMore() {
                ...
                String url = "http://mrsearch.000webhostapp.com/apirestAndroid/get/getAllPostsByUser.php?user_id="+mAuth.getUid()+"&from="+fromId+"&casetype=2";
                VolleySingleton.
    ...
    private void getPostsInicial(){
        String url = "http://mrsearch.000webhostapp.com/apirestAndroid/get/getAllPostsByUser.php?user_id="+mAuth.getUid()+"&from="+0+"&casetype=1";
        VolleySingleton.
                getInstance(getContext()).
                addToRequestQueue(
                        new JsonObjectRequest(
    ...
    private void getNewsPosts(){
        ...
        String url = "http://mrsearch.000webhostapp.com/apirestAndroid/get/getAllPostsByUser.php?user_id="+mAuth.getUid()+"&from="+case3+"&casetype=3";
        VolleySingleton.
                getInstance(getContext()).
                addToRequestQueue(
                        new JsonObjectRequest(
